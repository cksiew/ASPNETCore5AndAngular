...
namespace TestMakerFreeWebApp.Controllers
{
    public class TokenController : BaseApiController
    {
        ...
        private TokenResponseViewModel CreateAccessToken(string userId, string refreshToken)
        {
            ...
            // For more info, see https://tools.ieft.org/html/rfc7519#section-4.1
        ...
        public async Task<IActionResult> Facebook([FromBody]ExternalLoginRequestViewModel model)
        {
            try
            {
                ...
                if (user == null)
                {
                    ...
                    if (user == null)
                    {
                        // No user has been found: registere a new user using the info
                        ...
                        user = new ApplicationUser()
                        {
                            ...
                            // ensure the user will have a unique username
                            UserName = username,
                            Email = epInfo["email"],
                        ...
                        // Remove Lockout and E-Mail configuration
            ...
            string returnUrl = null, string remoteError = null)
        {
            ...
            if (user == null)
            {
                ...
                if (user == null)
                {
                    ...
                    var username = String.Format("{0}{1}{2}", info.LoginProvider,
